...
package object analytics
{
    ...
    case class ClassifierInt_crossValidate (name: String, nx: Int = 10, show: Boolean = false)
    case class ClassifierInt_crossValidateRand (name: String, nx: Int = 10, show: Boolean = false)
    ...
    case class ClassifierIntIn_crossValidate (name: String, nx: Int = 10, show: Boolean = false)
    case class ClassifierIntIn_crossValidateRand (name: String, nx: Int = 10, show: Boolean = false)
    ...
    case class ClassifierReal_crossValidate (name: String, nx: Int = 10, show: Boolean = false)
    case class ClassifierReal_crossValidateRand (name: String, nx: Int = 10, show: Boolean = false)
    ...
    case class ClassifierRealIn_crossValidate (name: String, nx: Int = 10, show: Boolean = false)
    case class ClassifierRealIn_crossValidateRand (name: String, nx: Int = 10, show: Boolean = false)
